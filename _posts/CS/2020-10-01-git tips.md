...
Starting with this posting, I will upload a series of articles that can help with Python development. The series will be written in four articles, and the contents are as follows, and if necessary, additional posts will be uploaded as a separate series.
...
The following are essential terminal commands for Git. It may be difficult to understand, but it is good to know only its purpose. As long as you understand each command's purpose, you can easily use Git through the GUI, which will be covered in the following section.
