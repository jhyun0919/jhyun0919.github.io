...
This article is about a review of the paper [[1]](https://arxiv.org/abs/1709.04875), and is the second part of a personal research project to utilize the use of Graph Neural Network to the field of cascading outage prediction or detection.
...
(check details of Localized convolutions in <a href="#appendix 7.4">appendix 7.4</a>)
...
## 6.7. Chebyshev Polynomial & Approximation [14, 15]
...
## 7.4. Localized Convolutional Filter
